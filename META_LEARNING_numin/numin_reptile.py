"""
Numin2 with Reptile - Simpler meta-learning that often works better on small data.
...
class Reptile:
    def __init__(self, model, outer_lr=0.001, inner_lr=0.01, inner_steps=10, device='cuda'):
...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoints_numin_reptile')
